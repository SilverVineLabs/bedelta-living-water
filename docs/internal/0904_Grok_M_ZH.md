...
| Pendle 公開敘事鎖 Safety Sentinel | ✅ | ✅ + V1.5/V2.0 路線圖不寫成已上線 yield |
...
- Eliza / Virtuals / Wayfinder / CrewAI 標 **⏳ V1.5**——Goldfeder / Pendle / HackQuest 視為 *don't badge what you didn't ship*。
...
產業組仍比內部 20 人模擬 **更嚴**（−0.06），但缺口從 09-03 的 −0.05～0.12 **略收窄**：誠實邊界（V1.5 降級、Stylus roadmap 標籤、88/12 完備分割）正好打在 Pendle / Goldfeder / HackQuest 的否決點上。
...
- **說服（新）：** V1.5/V2.0 把 Pendle 放進 **路線圖表** 而非 v1.0 已交付；8.2–11.8% 有現金流拆表且標非保證。Sentinel 邊界未回退。
