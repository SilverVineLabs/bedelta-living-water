...
See also: [`02_STANDARD_COMPLIANCE_AND_EIP_WIKI.md`](../architecture/02_STANDARD_COMPLIANCE_AND_EIP_WIKI.md) — EIP-7562 wiki entry.
...
|-------|--------|----------|
| **Oracle** | [`pendle-market-oracle-adapter.ts`](../../src/adapters/pendle/pendle-market-oracle-adapter.ts) | Sync cache · TTL 60s · `PENDLE_ORACLE_STALE` |
| **Registry** | [`pendle-pt-registry.ts`](../../src/adapters/pendle/pendle-pt-registry.ts) | `hydrateFromOracle` |
| **Soil** | `checkSoilResistance()` | `pendleOracle` + `pendleCrossGuard` probes |
| **Expiry** | [`pendle-pt-expiry-guard.ts`](../../src/adapters/pendle/pendle-pt-expiry-guard.ts) | `evaluatePendlePtExpiryRisk()` — fail-closed when PT maturity **&lt; 7 days** AND yield jitter **&gt; 200 bps** |
| **Cross-guard** | [`pendle-gmx-cross-guard.ts`](../../src/guards/pendle-gmx-cross-guard.ts) | Shadow Margin vs GMX maintenance |

**Dune telemetry:** [Live dashboard](https://dune.com/silvervinelabs/silvervine-citadel-telemetry) · [`DUNE_DASHBOARD_SPECIFICATION.md`](../telemetry/DUNE_DASHBOARD_SPECIFICATION.md) (production DuneSQL feed + activity chart + reconciliation panels).
