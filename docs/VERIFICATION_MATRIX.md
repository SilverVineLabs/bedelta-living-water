...
| `docker run --rm slivervine-citadel pnpm test` | Full Vitest regression bar (host-free) | **174 files | 764 PASS** *(Locked Minimum Proposal Baseline: 168 \| 742)* |
...
pnpm install
pnpm test                 # Tier 1 — Current Branch Live Expected Output: 174 files | 764 PASS (Locked Minimum Proposal Baseline: 168 | 742)
...
| **1** | `pnpm test` | Core engine · Soil · Wasm · Sequencer · Margin Buffer · adapters | **174 files | 764 PASS** *(Locked Minimum Proposal Baseline: 168 \| 742)* |
...
**SSOT:** **Locked Minimum Proposal Baseline:** 168 files | 742 PASS · **Current Branch Live Expected Output:** 174 files | 764 PASS · `risk-control.ts` 100% coverage
...
*SilverVine Labs · BUSL-1.1 · Verification Matrix · Locked Minimum Proposal Baseline: 168 \| 742 · Current Branch Live Expected Output: 174 \| 764*
