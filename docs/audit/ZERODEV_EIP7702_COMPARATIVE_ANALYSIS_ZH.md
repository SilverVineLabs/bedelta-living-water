...
| **基線** | Vitest **180 test files | 803 PASS Clean** · Wasm **91.2 KiB gzip** · Shield **p50 ~106 µs** |
...
| **回歸證明** | 廠商 QA / 審計快照 | **180 test files | 803 PASS Clean** · `zerodev-aa-gate` **4/4** · chaos **255/255** |
