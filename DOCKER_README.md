...
**Regression bar:** 133 Test Files | 716 Vitest PASS (100% Clean) · `tsc --noEmit` CLEAN
...
**License:** BUSL-1.1 · Grant evaluators retain full review rights. See [LICENSE](./LICENSE).