...
[![Vitest](https://img.shields.io/badge/Vitest-758%20PASS%20%28172%20files%29-brightgreen?logo=vitest)](https://github.com/SilverVineLabs/bedelta-living-water)
...
> **Locked Minimum Proposal Baseline:** **168 files | 742 PASS (100% Clean)** — official Grant proposal bar. **Current Branch Live Expected Output:** **172 files | 758 PASS (100% Clean · Exit Code 0)** on `pnpm test -- --run`.
...
3. `pnpm test -- --run` verifies **Current Branch Live Expected Output:** **172 files | 758 PASS (100% Clean · Exit Code 0)** *(Locked Minimum Proposal Baseline: 168 files | 742 PASS)*.
...
* **Current Branch Live Expected Output**: 🎯 **172 files | 758 PASS (100% Clean · Exit Code 0)** on `pnpm test -- --run`
...
```bash
# 1. Full Vitest suite (168 files | 742 PASS — live: 172 / 758)
pnpm test -- --run
