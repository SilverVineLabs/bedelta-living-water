...
export const DEV_GUIDE_TITLE =
  "Developer Setup Guide: How to mount `@slivervine/citadel-sdk` & query public telemetry.";

export const DEV_GUIDE_BODY =
  "Install `@slivervine/citadel-sdk`, mount the risk envelope provider, then poll the public telemetry health endpoint for CRI, soil resistance, and circuit-breaker state — no API key required.";
