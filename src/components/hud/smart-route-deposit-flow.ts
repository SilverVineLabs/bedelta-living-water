...
import { quoteRChainYieldToArbitrumGm } from "../../adapters/robinhood/r-chain-yield-router";
import { type GmPoolRouteKey, GMX_MARKET_REGISTRY } from "../../config/gmx-markets";
import { ROBINHOOD_TESTNET_CHAIN_ID, SLIVERVINE_GATE_ADDRESS } from "../../sdk/constants";
...
export function runSmartRouteDepositPreview(input: {
  ...
  const hedgeSymbol = quote.targetRoute === "GM_BTC_USDC" ? "BTC" : "ETH";
